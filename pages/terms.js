...
export default function About() {
  return (<>
    <Head>
      <title>Terms of Service | YouBarter</title>
    </Head>
    <div>
      <Nav />
      <div className={ui.relcont} style={{ background: 'var(--background-default)' }}>
        <div className={ui.mw800 + " " + ui.centerx + " " + ui.relative} style={{ padding: '15vh 0' }}>
          ...
          <p>
            ...
            programs or deliver viruses to your computer. Cookies are uniquely assigned to you and can only be read by a web
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, Youbarter and/or its licensors own the intellectual property rights for all material on
            Youbarter. All intellectual property rights are reserved. You may access this from Youbarter for your own personal
          ...
          <p>
            Parts of this website offer users an opportunity to post and exchange opinions and information in certain areas of
          ...
          <p>
            ...
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Youbarter; and (d)
          ...
          <p>
            ...
            must inform us by sending an e-mail to Youbarter. Please include your name, your organization name, contact
          ...
          <p>
            ...
            Using any other description of our Website being linked to that makes sense within the context and format of
            content on the linking party&apos;s site.
            No use of Youbarter&apos;s logo or other artwork will be allowed for linking absent a trademark license agreement.
          </p>
          <p>
            Content Liability:
